...
// SP coil images
SP12_1 = call("ij.Prefs.get", "myMacros.SP12_1", "defaultValue");
SP34_1 = call("ij.Prefs.get", "myMacros.SP34_1", "defaultValue");
SP56_1 = call("ij.Prefs.get", "myMacros.SP56_1", "defaultValue");
SP67_1 = call("ij.Prefs.get", "myMacros.SP67_1", "defaultValue");

SP12_2 = call("ij.Prefs.get", "myMacros.SP12_2", "defaultValue");
SP34_2 = call("ij.Prefs.get", "myMacros.SP34_2", "defaultValue");
SP56_2 = call("ij.Prefs.get", "myMacros.SP56_2", "defaultValue");
SP67_2 = call("ij.Prefs.get", "myMacros.SP67_2", "defaultValue");


// run SNR TESTs :
SNR_TEST(SP12_1,SP12_2,Results_dir);
SNR_TEST(SP34_1,SP34_2,Results_dir);
SNR_TEST(SP56_1,SP56_2,Results_dir);
SNR_TEST(SP67_1,SP67_2,Results_dir);
